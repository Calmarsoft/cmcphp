...
class cmc {
    ...
    static public function getPoweredByBanner($path) {
        ...
        if ($banner === true)
            $banner = '<style>.cmc-poweredby{float:right;margin-right:20px;margin-top:20px;font-size:small;text-align:right}</style><div class="cmc-poweredby">Powered by CMC (c) <a href="http://cmc.calmarsoft.com/">CalmarSoft</a></div>';
        return $banner;
    }
